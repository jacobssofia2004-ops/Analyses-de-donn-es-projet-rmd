...
Le graphique montre larépartition des types de magmas en fonction du volcans, des laves ainsi que la classification. 
...
La relation entre la magnitude et la profondeur en fonction des volcans. 

Il n'y a pas de relation de linéarité. 
```{r}
